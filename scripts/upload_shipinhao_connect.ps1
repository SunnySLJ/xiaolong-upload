...
if (-not $listening) {
    ...
    Start-Process -FilePath $chrome -ArgumentList "--remote-debugging-port=$port", "--user-data-dir=$profileDir", "https://channels.weixin.qq.com/platform/post/create" -WindowStyle Normal
