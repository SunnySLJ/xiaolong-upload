...
- macOS 项目根目录：`/Users/mima0000/.openclaw/workspace/xiaolong-upload`
...
```bash
/opt/homebrew/bin/python3.11 upload.py --platform kuaishou "/Users/mima0000/Desktop/generated_video.mp4" "记录生活小确幸" "把今天的片段剪成短视频，记录平凡里的小美好。喜欢的话点个赞～" "生活记录,日常分享,美好时光,vlog"
```
...
4. 如果普通 profile 模式报 `Failed to connect to browser`：
   - 手动拉起专用 Chrome：
   - `open -na "Google Chrome" --args --remote-debugging-port=9225 --user-data-dir="/Users/mima0000/.openclaw/workspace/xiaolong-upload/cookies/chrome_connect_ks" --start-maximized https://cp.kuaishou.com/article/publish/video`
   - 再用 connect 模式上传：
...
- 时间：`2026-03-27`
- 视频：`/Users/mima0000/Desktop/generated_video.mp4`
- 文案：
  - 标题：`记录生活小确幸`
...
```
[INFO] 开始清理视频文件
[INFO] 输出目录：/Users/mima0000/.openclaw/workspace/xiaolong-upload/flash_longxia/output
[INFO] 保留最近 1 天的文件
